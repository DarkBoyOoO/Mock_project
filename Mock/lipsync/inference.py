...
def get_config(path1):
	global args
	parser = argparse.ArgumentParser(description='Inference code to lip-sync any noisy videos using the student-lipsync models')

	parser.add_argument('--checkpoint_path', default="model/lipsync_student.pth", type=str, help='Name of saved checkpoint to load weights from', required=False)
	...
	parser.add_argument('--audio', type=str, default=path1, help='Filepath of nosy video/audio file', required=False)
