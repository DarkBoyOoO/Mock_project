...
def process(path1):
	...
	parser.add_argument('--lipsync_student_model_path', default="model/lipsync_student.pth" , type=str, required=False, help='Path of the lipgan model to generate frames')
	parser.add_argument('--checkpoint_path', default="model/denoising.pt", type=str,  required=False, help='Path of the saved checkpoint to load weights from')
	parser.add_argument('--input', type=str, default=path1, required=False, help='Filepath of input noisy audio/video')
